...
def serialize_article(article, lang="en"):
    ...
    return {
        ...
        "imageIdeas": body.get("image_ideas", []),
        "socialTitles": body.get("social_titles", []),
        "linkedinPost": body.get("linkedin_post", ""),
        "facebookPost": body.get("facebook_post", ""),
        "internalLinks": body.get("internal_links", []),
        "externalLinks": body.get("external_links", []),
