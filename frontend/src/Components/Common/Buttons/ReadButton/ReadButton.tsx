...
export const ReadButton = ({ text, onClick, href }: ReadButtonProps) => {
  ...
  if (href) {
    return (
      <Link className={styles.readButton} href={href}>
        {content}
      </Link>
    );
  }
