...
const resources: ResourceConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "purchase_reference", label: "Purchase reference", type: "text" },
      { key: "subject", label: "Request subject", type: "text", fullWidth: true },
      { key: "issue_description", label: "Issue description", type: "textarea", fullWidth: true },
      { key: "resolution_notes", label: "Resolution notes", type: "textarea", fullWidth: true },
      { key: "status", label: "Status", type: "select", options: afterSalesStatusOptions },
      { key: "priority", label: "Priority", type: "select", options: afterSalesPriorityOptions },
