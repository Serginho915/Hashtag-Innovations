...
export const MOCK_EVENTS: CommunityEvent[] = [
  {
    ...
    speaker: { id: "spk-1", name: "Andrew Nikolov", expertId: "expert-1" },
  ...
  },
  {
    ...
    speaker: { id: "spk-3", name: "David Chen", expertId: "expert-2" },
  ...
  },
  {
    ...
    speaker: { id: "spk-4", name: "Elena Rostova", expertId: "expert-3" },
  ...
  },
  {
    ...
    speaker: { id: "spk-6", name: "Sophia Martinez", expertId: "expert-4" },
